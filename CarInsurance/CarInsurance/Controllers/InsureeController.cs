...
namespace CarInsurance.Controllers
{
    public class InsureeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,EmailAddress,DateOfBirth,CarYear,CarMake,CarModel,DUI,SpeedingTickets,CoverageType,Quote")] Insuree insuree)
        {
            ...
            {
                insuree = CalculateQuote(insuree);
        ...
        public Insuree CalculateQuote(Insuree insuree)
        {
            decimal quote = 50;

            // calculate the insuree's age
            int age = DateTime.Now.Year - insuree.DateOfBirth.Year;
            // if insuree's birthday has not been reached, subtract a year
            if (DateTime.Now.DayOfYear - insuree.DateOfBirth.DayOfYear < 0)
                age--;
